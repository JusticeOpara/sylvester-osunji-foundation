  ...
  return (
    <div className='w-full hg-[50vh] bg-[#222] text-white py-12 max-md:py-4 '>
      ...
      <div className='flex flex-row w-full px-28 pb-6 max-md:px-4 max-md:flex-col max-md:gap-4 2xl:justify-center 2xl:mb-12 2xl:pb-0'>
        <div className='flex flex-row w-full h-full items-center max-md:gap-8  '>

          <img src={help} className="w-[228.9px] max-md:w-[170px] max-md:h-[100px] h-[152.6px] mt-5 2xl:mt-0" />

          <div className='flex flex-col h-full gap-3 justify-between max-md:justify-evenly max-md:w-full max-md:text-center max-md:items-center max-md:gap-2'>
        ...
        <div className='flex flex-row w-full h-full  max-md:gap-8 items-center 2xl:justify-center '>
      
            <img src={donate} className="w-[228.9px] h-[152.6px] mt-5 2xl:mt-0 max-md:w-[170px] max-md:h-[100px]" />
           
          <div className='flex flex-col h-full justify-between max-md:justify-evenly max-md:w-full gap-3 max-md:text-center max-md:items-center max-md:gap-2'>
