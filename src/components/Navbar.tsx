...
const Navbar: React.FC = () => {
    return (
        <div className='w-full bg-slate-400 h-[84px] flex items-center'>

            <div className='flex w-full bfg-slate-600 justify-between px-[170px] '>
                <div className='flex items-center '>
                    <img src={NavLogo} className='w-[40px] h-[40px] rounded-2xl' />
                    <p className='text-[18px] leading-normal font-normal text-[#111] '>Sylvester Osunji Foundation(SDF)</p>
